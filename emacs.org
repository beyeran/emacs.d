...
# Time-stamp: <2012-10-26 16:20:32 tsathoggua>
#
#+STARTUP: indent
#+STARTUP: hidestars
...
** flashcard
#+begin_src emacs-lisp :tangle beyeran/beyeran-flashcard.el
;;
;; file: beyeran-flashcard.el
;;
...
(add-hook 'flashcard-positive-feedback-functions 
		  'flashcard-method-leitner-positve-feedback)
...
(defun beyeran/flashcard-add-russian-card (deck card)
  "Add CARD to DECK."
  (interactive (list flashcard-deck
                     (flashcard-make-card
					  (read-from-minibuffer "Question: " nil nil nil nil nil (set-input-method 'russian-computer))
                      (read-from-minibuffer "Answer: " nil nil nil nil nil (set-input-method 'latin-1-alt-postfix)))))
