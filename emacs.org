...
*** JIRA
#+BEGIN_SRC emacs-lisp :tangle src/jira.el
  (setq request-backend 'url-retrieve)

  (setq jiralib-url "https://mobility-jira.nuance.com")

  (defconst org-jira-progress-issue-flow
    '(("Defined" . "In Progress")
      ("In Progress" . "Completed")))

  (defconst org-jira-default-jql
    "project = \"Project Tracking NLU\" AND issuetype = sub-task AND Language = deu-DEU AND assignee = currentUser() AND Sprint = 2235 ORDER BY priority DESC")

  (defconst jiralib-token
    `("Cookie" . "atlassian.xsrf.token=BD2V-NTI2-H1R4-850Q|3d8dfc0b2d8fb234e2b2dd967a77a061854b7707|lin; JSESSIONID=F76AF6D45DDF4A23715BFD0DA241308E; jira.editor.user.mode=wysiwyg; visid_incap_1639326=k9LPsOgoS0aoHDvR/HQ9g38l41sAAAAAQUIPAAAAAACS2Gd2ifECODo484YpRk9O; nlbi_1639326=k+pLM3rPQFlqBxkR9N1I7gAAAADdU4qaN8UwIZnSHPEHrse2; incap_ses_259_1639326=0+SnBY9XgAtU/2SQlyiYAwVX5FsAAAAAmlQ545FVPuY0YzFe0d8b0A==;"))
#+END_SRC
*** Which Function
#+BEGIN_SRC emacs-lisp :tangle src/usability.el
...
#+BEGIN_SRC emacs-lisp :tangle src/apb-python.el
  ...
  (remove-hook 'python-mode-hook 'aggressive-indent-mode)
...
#+BEGIN_SRC emacs-lisp :tangle src/ob-fas.el
  ;;; ob-fas.el --- org-babel functions for FAS files
  (require 'ob)
  (require 'ob-ref)
  (require 'ob-comint)
  (require 'ob-eval)

  (add-to-list 'org-babel-tangle-lang-exts '("fas" . "fieldannotatedstring"))
...
** JIRA
#+BEGIN_SRC emacs-lisp :tangle src/jira-mode.el
  (add-to-list 'load-path (expand-file-name "jira-markup-mode" "~/.emacs.d/etc/"))

  (require 'jira-markup-mode)

  (add-to-list 'auto-mode-alist '(".*jira.*\\.txt$" . jira-markup-mode))
#+END_SRC
